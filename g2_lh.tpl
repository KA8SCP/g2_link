...
<table width="700" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#26354A">
    ...
    <td height="70" colspan="2" class="logo" nowrap="nowrap">
      <a href="http://www.yrarc.org">{{TITLE}}</a> Dashboard <span class="tagline">| Gateway Status and Control</span>
    </td>
    <td width="15">&nbsp;</td>
  </tr>
  <tr bgcolor="#FF0000">
            ...
            <table width="100%" border="1" align="center" cellspacing="2" cellpadding="0">
              ...
              {{#LOCAL}}<tr bgcolor="#D3DCE6">
                <td width="95" align="center" valign="middle"><span class="style1">
                  {{#GPS}}<a href="http://aprs.fi/?call={{APRSCALL}}"><strong>{{CALL}}</strong></a>{{/GPS}}
                  {{#NOGPS}}{{CALL}}{{/NOGPS}}
                </span></td>
