...
/*
* Build Instructions
* Download, make and install ctemplate from https://code.google.com/p/ctemplate/.
* g2_lh has been tested with ctemplate v2.2 and v2.3
* Build g2_lh using: g++ -o g2_lh g2_lh.cpp -lctemplate_nothreads --static
* Use cron to run the program every minute or two. See help text for instructions.
*/
...
/*
v2.04	Chris, VE3NRT:	Add unistd.h to includes for close on some linxes
v2.03	Chris, VE3NRT:  Fix APRS variables for calls shorter than 6 letters.
...
static unsigned int port = 50001;		// Standard port
static bool debug = 0;
...
static error_t cmdLine(int argc, char** argv)
{
   ...
   static struct argp_option options[] = {
      ...
      {"port", 'p', "50001", 0, "IP Port number for g2_link"},
...
// Call sign heard
   ...
   for (i=0;i<=8;i++)
   {
      ...
      } else temp_string[i-sp]=temp_string[i];
   };
